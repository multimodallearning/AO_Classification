...
task = Task.init(project_name="AO Classification/txt baseline", auto_resource_monitoring=False, reuse_last_task_id=False)

# training routine
cli = LightningCLI(model_class=TxtAOClassifier, datamodule_class=GrazPedWriDataModule)
